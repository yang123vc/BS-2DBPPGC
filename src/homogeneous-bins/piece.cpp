...
//Obtiene una rotación de angulo_a_rotar grados con respecto a la posición inicial de la pieza. 
...
void
PIEZA::set_ptos_diag_rot ()
{
  puntos_diagonal_base = puntos_angulo_usado;
}

vector<PUNTO>
PIEZA::get_ptos_diag_rot ()
{
  return puntos_diagonal_base;
}
