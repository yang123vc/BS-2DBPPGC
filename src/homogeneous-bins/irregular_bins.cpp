...
//Esta función crea un elemento de la clase IRR_BIN a partir de otro de la clase BIN
...
int
BreakTie (vector<EDGES> e_pza, vector<PUNTO> ptos_sect, EDGES esec, EDGES epza)
{
  int best = -1;
