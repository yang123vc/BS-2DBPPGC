...
vector<PIEZA> read_pieces(const string &name_sol) {
	vector<PIEZA> sol;
	char cadena[128];
...
bool equal_double(double a, double b, double prec) {
...
bool equal_pto(PUNTO a, PUNTO b) {
...
int Position(PUNTO A, PUNTO B, PUNTO C) {
	int pos = 100;
	double crosprod;
