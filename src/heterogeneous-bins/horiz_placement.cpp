...
double
HorAligMatch(IRR_BIN &bin, vector<PIEZA*> list, PIEZA convex_hull, int &best_e1,
		int &best_e2, double &best_d, int &best_p, int &best_m);
double
...
double HorAligMatch(IRR_BIN &bin, vector<PIEZA*> list, PIEZA convex_hull,
		int &best_e1, int &best_e2, double &best_d, int &best_p, int &best_m) {
...
double VertGuillCut(IRR_BIN &ib_node, vector<PIEZA*> list, PIEZA convex_hull,
